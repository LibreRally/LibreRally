...
namespace LibreRally.HUD
{
	...
	public sealed class SetupUiShellOverlay : GameSystemBase
	{
		...
		{
			var panel = CreateCardPanel(width: 272, background: isSelected ? PanelSelectedColor : PanelAltColor);
		...
		private void HandleNavigationInput()
		{
			...
			if (_game.Input.IsKeyPressed(Keys.Escape) ||
			    pad?.IsButtonPressed(GamePadButton.B) == true ||
			    pad?.IsButtonPressed(GamePadButton.Start) == true)
			{
